          ...
          <Form.Row>
            <Col >
              <Form.Control
                ...
                type="text"
                size="lg"
                placeholder="Search by state abbr."
              />
            </Col>
            <Col>
              <p>AL,AK,AZ,AR,CA,CO,CT,DE,FL,GA,HI,ID,IL,IN,IA,KS,KY,LA,ME,MD,MA,MI,MN,MS,MO,<br>
              </br>MT,NE,NV,NH,NJ,NM,NY,NC,ND,OH,OK,OR,PA,RI,SC,SD,TN,TX,UT,VT,VA,WA,WV,WI,WY</p>
            </Col>
            <Col>
